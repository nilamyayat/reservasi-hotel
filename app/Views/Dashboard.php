...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-warning border-bottom shadow-lg">
  <h5 class="my-0 mr-md-auto font-weight-normal">ABAS HOTEL</h5>
